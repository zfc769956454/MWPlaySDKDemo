...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="HunHeFramework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14HunHeFramework13OnAckCallback")
...
SWIFT_CLASS("_TtC14HunHeFramework7SSLCert")
...
SWIFT_CLASS("_TtC14HunHeFramework16SocketAckEmitter")
...
SWIFT_CLASS("_TtC14HunHeFramework14SocketAnyEvent")
...
///
/// \endcode
SWIFT_CLASS("_TtC14HunHeFramework19SocketClientManager")
...
SWIFT_PROTOCOL("_TtP14HunHeFramework16SocketEngineSpec_")
...
SWIFT_CLASS("_TtC14HunHeFramework12SocketEngine")
...
@interface SocketEngine (SWIFT_EXTENSION(HunHeFramework))
- (void)URLSessionWithSession:(NSURLSession * _Nonnull)session didBecomeInvalidWithError:(NSError * _Nullable)error;
@end


SWIFT_PROTOCOL("_TtP14HunHeFramework18SocketEngineClient_")
@protocol SocketEngineClient
...
SWIFT_CLASS("_TtC14HunHeFramework14SocketIOClient")
...
SWIFT_CLASS("_TtC14HunHeFramework9WebSocket")
