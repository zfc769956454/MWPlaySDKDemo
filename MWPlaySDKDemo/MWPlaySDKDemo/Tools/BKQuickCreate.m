...
@interface BKQuickCreate ()

@end

@implementation BKQuickCreate
...
+ (UILabel *)labelNOAutoresizeTextColor:(UIColor *)textColor
    ...
    lable.text = text;
    lable.preferredMaxLayoutWidth = maxLayoutWidth * 1.0;
    lable.textColor = textColor;
    lable.backgroundColor = BGColor;
    lable.numberOfLines = 0;
    lable.textAlignment = textAlignment;
...
+ (void)createAlertWithParentVC:(UIViewController *)vc andTitle:(NSString *)title message:(NSString *)message leftTitle:(NSString *)leftTitle leftAction:(void (^)(void))leftAction rightTitle:(NSString *)rightTitle rightAction:(void (^)(void))rightAction {
