...
#import "BKGCDTimerManager.h"

@interface BKGCDTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end


@implementation BKGCDTimerManager

#pragma mark - Public Method
+ (BKGCDTimerManager *)sharedInstance {
    static BKGCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[BKGCDTimerManager alloc] init];
    });
