...
@interface MWGCDTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@end


@implementation MWGCDTimerManager

#pragma mark - Public Method
+ (MWGCDTimerManager *)sharedInstance {
    static MWGCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[MWGCDTimerManager alloc] init];
    });
