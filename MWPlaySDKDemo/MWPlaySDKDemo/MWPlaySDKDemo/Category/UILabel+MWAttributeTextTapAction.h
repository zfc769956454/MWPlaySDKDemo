//
//  UILabel+MWAttributeTextTapAction.h
//
...
@protocol MWAttributeTapActionDelegate <NSObject>
@optional
/**
...
@interface MWAttributeModel : NSObject
...
@interface UILabel (MWAttributeTextTapAction)
