...
@interface BKPageSegmentStyle : NSObject
...
/** 当设置scrollTitle=NO的时候标题会平分宽度, 如果您希望在滚动的过程中cover或者scrollLine的宽度随着变化设置这个属性为YES 默认为NO*/
...
/** 是否显示小红点 默认为NO */
@property (nonatomic,getter = isBadgeViewShow, assign) BOOL badgeViewShow;
